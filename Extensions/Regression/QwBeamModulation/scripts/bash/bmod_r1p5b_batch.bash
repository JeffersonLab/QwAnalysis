...
dbName="qw_run1_pass5b" # JHoskins 6-2-13

#export QW_ROOTFILES=/volatile/hallc/qweak/QwAnalysis/run2/rootfiles

echo "QW_ROOTFILES=$QW_ROOTFILES"

export BMOD_OUT=/w/hallc/qweak/QwAnalysis/run1/pass5b_bmod_regression/output

run_number=$1
fseg=$2

log=/w/hallc/qweak/QwAnalysis/run1/pass5b_bmod_regression/output/out_files
