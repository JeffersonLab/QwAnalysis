...
echo ${scriptPath}/upload_beammod_data.pl -u qwreplay -n cdaql6 -d ${dbName} -prf  ${scriptPath} ${REGRESSION}/regression.dat ${SLOPES}/slopes.dat

${scriptPath}/upload_beammod_data.pl -u qwreplay -n cdaql6 -d ${dbName} -prf  ${scriptPath} ${REGRESSION}/regression.dat ${SLOPES}/slopes.dat
