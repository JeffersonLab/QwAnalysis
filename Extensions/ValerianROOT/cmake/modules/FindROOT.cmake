...
MACRO (ROOT_GENERATE_DICTIONARY INFILES LINKDEF_FILE OUTFILE INCLUDE_DIRS_IN)
  ...
  foreach ( _infile ${INFILES} )
    set (_infiles ${_infiles} ${_infile})
  endforeach( _infile ${INFILES})
 

  MESSAGE("INFILES: ${_infiles}")
  MESSAGE("OutFILE: ${OUTFILE}")
  MESSAGE("LINKDEF_FILE: ${LINKDEF_FILE}")
  MESSAGE("INCLUDE_DIRS: ${INCLUDE_DIRS}")
  ...
  if (CMAKE_SYSTEM_NAME MATCHES Linux)
    ADD_CUSTOM_COMMAND(OUTPUT ${OUTFILES}
       ...
       ARGS -f ${OUTFILE} -c -DHAVE_CONFIG_H ${INCLUDE_DIRS} -p ${_infiles} ${LINKDEF_FILE} DEPENDS ${INFILES} ${LINKDEF_FILE})
  else (CMAKE_SYSTEM_NAME MATCHES Linux)
    if (CMAKE_SYSTEM_NAME MATCHES Darwin)
      ADD_CUSTOM_COMMAND(OUTPUT ${OUTFILES}
       COMMAND DYLD_LIBRARY_PATH=${ROOT_LIBRARY_DIR} ROOTSYS=${ROOTSYS} ${ROOT_CINT_EXECUTABLE}
       ARGS -f ${OUTFILE} -c -DHAVE_CONFIG_H ${INCLUDE_DIRS} ${_infiles} ${LINKDEF_FILE} DEPENDS ${INFILES} ${LINKDEF_FILE})
    endif (CMAKE_SYSTEM_NAME MATCHES Darwin)
  endif (CMAKE_SYSTEM_NAME MATCHES Linux)
  MESSAGE("Custom command: LD_LIBRARY_PATH=${ROOT_LIBRARY_DIR} ROOTSYS=${ROOTSYS} ${ROOT_CINT_EXECUTABLE} -f ${OUTFILE} -c -DHAVE_CONFIG_H ${INCLUDE_DIRS} -p ${_infiles} ${LINKDEF_FILE} ")
