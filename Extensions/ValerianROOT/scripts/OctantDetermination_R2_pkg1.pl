...
my $OutputDir = $YouAreHere . "/" . $script . "_R2_pkg1";
...
my $MissingFile = $MissingDir . "/" . $script . "R2Pkg1_Missing.txt" ;
...
while ( my $runnum = <ALLRUNS> )
{
  ...
  my $OctantDeterminationOut = $OutputDir . "/" . $script . "_R2_pkg1_" . $runnum . ".txt"; 
  #debug
