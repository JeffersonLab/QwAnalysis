...
///
/// \ingroup QwGUIDatabaseSummary

#ifndef QWGUIDATABASESUMMARY_H
#define QWGUIDATABASESUMMARY_H
...
#include <THStack.h>
 ...
 class QwGUIDatabaseSummary : public QwGUISubSystem {
  ...
  //time scales
  static const char *TimeScales[N_TIME_SCALES];
...
/*   TObject*             GetLegend(Int_t ind); */
 ...
 public:
  ...
  QwGUIDatabaseSummary(const TGWindow *p, const TGWindow *main, const TGTab *tab,
		     const char *objName, const char *mainname, UInt_t w, UInt_t h);

  ~QwGUIDatabaseSummary();
