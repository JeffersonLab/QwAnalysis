...
c5->Divide(2,5);
c5->cd(1);
chain . Draw("(asym_qwk_bcm1-asym_qwk_bpm3h09b_EffectiveCharge)*1e6",cut);
c5->cd(2);
chain . Draw("(asym_qwk_bcm1-asym_qwk_bpm3c12_EffectiveCharge)*1e6",cut);
c5->cd(3);
chain . Draw("(asym_qwk_bcm2-asym_qwk_bpm3h09b_EffectiveCharge)*1e6",cut);
c5->cd(4);
chain . Draw("(asym_qwk_bcm2-asym_qwk_bpm3c12_EffectiveCharge)*1e6",cut);
c5->cd(5);
chain . Draw("(asym_qwk_bcm5-asym_qwk_bpm3h09b_EffectiveCharge)*1e6",cut);
c5->cd(6);
chain . Draw("(asym_qwk_bcm5-asym_qwk_bpm3c12_EffectiveCharge)*1e6",cut);
c5->cd(7);
chain . Draw("(asym_qwk_bcm6-asym_qwk_bpm3h09b_EffectiveCharge)*1e6",cut);
c5->cd(8);
chain . Draw("(asym_qwk_bcm6-asym_qwk_bpm3c12_EffectiveCharge)*1e6",cut);
c5->cd(9);
chain . Draw("(asym_qwk_bpm3h09b_EffectiveCharge-asym_qwk_bpm3c12_EffectiveCharge)*1e6",cut);
