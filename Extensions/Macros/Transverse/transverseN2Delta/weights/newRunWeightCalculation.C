...
void newRunWeightCalculation(Int_t run_number){
  ...
  /*
    Format of the file weightAliasCalc_run_number-.txt is md1neg md2neg ... md8neg md1pos md2pos ... md8pos
  */

  if(run_number>= 9418  && run_number <= 9593  ) {mystr = "weightAliasCalc_9418-.txt";}
  if(run_number>= 9594  && run_number <= 9702  ) {mystr = "weightAliasCalc_9594-.txt";}
  if(run_number>= 9703  && run_number <= 9809  ) {mystr = "weightAliasCalc_9703-.txt";}
  ...
  if(run_number>= 15593 && run_number <= 16064 ) {mystr = "weightAliasCalc_14017-.txt";}

  if(run_number>= 16065 && run_number <= 16066 ) {mystr = "weightAliasCalc_16065-16066.txt";}
  if(run_number>= 16067 && run_number <= 16069 ) {mystr = "weightAliasCalc_16067-16069.txt";}
  if(run_number>= 16070 && run_number <= 16072 ) {mystr = "weightAliasCalc_16070-16072.txt";}
  if(run_number>= 16096 && run_number <= 16105 ) {mystr = "weightAliasCalc_16096-16105.txt";}
  if(run_number>= 16106 && run_number <= 16111 ) {mystr = "weightAliasCalc_16106-16111.txt";}
  if(run_number>= 16112 && run_number <= 16114 ) {mystr = "weightAliasCalc_16112-16114.txt";}
  if(run_number>= 16115 && run_number <= 16124 ) {mystr = "weightAliasCalc_16115-16124.txt";}
  if(run_number>= 16129 && run_number <= 16132 ) {mystr = "weightAliasCalc_16129-16132.txt";}
  if(run_number>= 16133 && run_number <= 16137 ) {mystr = "weightAliasCalc_16133-16137.txt";}
  if(run_number>= 16138 && run_number <= 16143 ) {mystr = "weightAliasCalc_16138-16143.txt";}
  if(run_number>= 16144 && run_number <= 16147 ) {mystr = "weightAliasCalc_16144-16147.txt";}
  if(run_number>= 16148 && run_number <= 16151 ) {mystr = "weightAliasCalc_16148-16151.txt";}
  if(run_number>= 16152 && run_number <= 16158 ) {mystr = "weightAliasCalc_16152-16158.txt";}
  if(run_number>= 16160 && run_number <= 16161 ) {mystr = "weightAliasCalc_16160-16161.txt";}

  if(run_number>= 16162 && run_number <= 19500 ) {mystr = "weightAliasCalc_14017-.txt";}
...
//       printf("%5.7f %5.7f, %s\n",calcYpmtposMean[i],calcYpmtposRMS[i],cut[i].Data());
  ...
  if(ALLBARSWEIGHT){
    ...
    sprintf(textfileAllbarsWtPos,"%dtextfileAllbarsWtPosNew.txt",run_number);
    sprintf(textfileAllbarsWtNeg,"%dtextfileAllbarsWtNegNew.txt",run_number);
    ...
    pad2->Draw();
    pad1->cd();
    TString text = Form("%d: (new w's) Normalized Yield of PMTs w.r.t Allbars for Main Detectors {16*yield_mdipos(neg)/SUM(wi)}",run_number);
    ...
    c1->Modified();
    c1->Update();
    c1->SaveAs(Form("%dnormalizedWeightedYieldsAllTubesNew.png",run_number));
  }
  /************************************/
  /************************************/
  ...
  if(BARSUMWEIGHT){
    ...
    sprintf(textfileBarsumWtPos,"%dtextfileBarsumWtPosNew.txt",run_number);
    sprintf(textfileBarsumWtNeg,"%dtextfileBarsumWtNegNew.txt",run_number);
    ...
    pad2->Draw();
    pad1->cd();
    TString text = Form("%d: (new w's) Normalized Yield of PMTs w.r.t Barsum for Main Detectors {2*yield_mdipos(neg)/(wipos+wineg)}",run_number);
    t1 = new TText(0.17,0.3,text);
    t1->SetTextSize(0.5);
    t1->Draw();
    pad2->cd();
    ...
    c2->Modified();
    c2->Update();
    c2->SaveAs(Form("%dnormalizedWeightedYieldsBarsumNew.png",run_number));
  }
  /************************************/
  /************************************/
  ...
  if(PMTWEIGHT){
    ...
    sprintf(textfileWtPos,"%dtextfileWtPosNew.txt",run_number);
    sprintf(textfileWtNeg,"%dtextfileWtNegNew.txt",run_number);
    ...
    pad2->Draw();
    pad1->cd();
    TString text = Form("%d: (new w's) Weighted Yield of PMTs for Main Detectors {yield_mdipos(neg)*wi}",run_number);
    ...
    c3->Modified();
    c3->Update();
    c3->SaveAs(Form("%dweightedYieldsNew.png",run_number));
  }
  ...
  if(PMTWEIGHTDIFF){
    ...
    sprintf(textfileWtDiff,"%dtextfileWtDiffNew.txt",run_number);
    ...
    pad2->Draw();
    pad1->cd();
    TString text = Form("%d: (new w's) Yield Diffrence of Pos and Neg PMT for MDs {2*(yield_mdineg*wineg-yield_mdipos*wipos)/(yield_mdineg*wineg+yield_mdipos*wipos)}",run_number);
    ...
    c4->Update();
    c4->SaveAs(Form("%dweightedYieldsDifferenceNew.png",run_number));
  }
  /************************************/
  /************************************/
