...
TString quartz_bar_SUM[8]= {"qwk_dslumi1","qwk_dslumi2","qwk_dslumi3","qwk_dslumi4",
...
int main(Int_t argc,Char_t* argv[])
{
  ...
  fileAsym.open(Form("dirPlot/%s_%s_%s_%s_DSLumi_%s_regression_%s_%s_%s_asym_%s.txt"
  ...
  fileYield.open(Form("dirPlot/%s_%s_%s_%s_DSLumi_%s_regression_off_off_%s_yield_%s.txt"
	  ,interaction.Data(),qtor_stem.Data(),polar.Data(),outputAvg.Data(),target.Data()
