...
//   fit4->SetParNames("A_{M}","#phi_{0}","C");
  ...
  fitH->SetParNames("A_{M}","#phi_{0}","C");
  fitV->SetParNames("A_{M}","#phi_{0}","C");
...
//   stats4->SetFillColor(kWhite); 
  ...
  statsH->SetX1NDC(x_lo_stat_in4); statsH->SetX2NDC(x_hi_stat_in4); statsH->SetY1NDC(0.72);statsH->SetY2NDC(0.95);
  statsV->SetX1NDC(x_lo_stat_in4); statsV->SetX2NDC(x_hi_stat_in4); statsV->SetY1NDC(0.47);statsV->SetY2NDC(0.70);
...
//   legend->AddEntry(grp_diff,Form("A_{measured} = %4.2f #pm %4.2f ppm",p0diff,ep0diff), "lp");
  legend->AddEntry(grp_diffH,Form("A_{measured}^{H} = %4.2f #pm %4.2f ppm",p1H,ep1H), "lp");
  legend->AddEntry(grp_diffV,Form("A_{measured}^{V} = %4.2f #pm %4.2f ppm",p1V,ep1V), "lp");
