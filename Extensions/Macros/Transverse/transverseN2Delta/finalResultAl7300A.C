...
//   Double_t dAmsr_dblpeak_h,dAmsr_dblpeak_v,dAmsr_dblpeak;
  ...
  A_msr_h          = -0.1079; // std. reg., no fit to phi_0
  dAmsr_stat_h     = 1.083;
//   A_msr_h          = -0.1114; // 5+1 reg., no fit to phi_0
//   dAmsr_stat_h     = 1.088;
//   A_msr_h          = -1.245;
//   dAmsr_stat_h     = 1.087;
...
//   cout<<blue<<"USLumi A_v "<<A_uslumi_v<<" +- "<<dAuslumi_v<<normal<<endl;
  ...
  dAmsr_nonlin_h = TMath::Abs(-0.05*A_msr_h);
