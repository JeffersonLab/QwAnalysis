...
//   TFile *f = new TFile("dirPlot/transverseN2deltaDiff.root","RECREATE");
  TFile *f = new TFile(Form("dirPlot/%s_%s_%s_%s_USLumiSum_Sum_modified_regression_%s_%s_%s_asym_%s.root"
		     ,interaction.Data(),qtor_stem.Data(),polar.Data(),target.Data()
...
//  TString s = "octant/I:run_number/F:hwp/I:asym/F:asymError/F:asymRMS/F";
 TString s = "run_number/F:hwp/I:uslumi1_sum/F:uslumi1_sumError/F:uslumi1_sumRMS/F:uslumi3_sum/F:uslumi3_sumError/F:uslumi3_sumRMS/F:uslumi5_sum/F:uslumi5_sumError/F:uslumi5_sumRMS/F:uslumi7_sum/F:uslumi7_sumError/F:uslumi7_sumRMS/F:uslumi_sum/F:uslumi_sumError/F:uslumi_sumRMS/F";
 
//  Long64_t nlines = t->ReadFile("dirPlot/diff.txt",Form("%s",s.Data()));
 Long64_t nlines = t->ReadFile(Form("dirPlot/%s_%s_%s_%s_USLumiSum_Sum_modified_regression_%s_%s_%s_asym_%s.txt"
		     ,interaction.Data(),qtor_stem.Data(),polar.Data(),target.Data()
		     ,reg_calc.Data(),reg_set.Data(),outputAvg.Data(),database_stem.Data()),Form("%s",s.Data()));
 
  cout<<Form("dirPlot/%s_%s_%s_%s_USLumiSum_Sum_modified_regression_%s_%s_%s_asym_%s.root"
		     ,interaction.Data(),qtor_stem.Data(),polar.Data(),target.Data()
	     ,reg_calc.Data(),reg_set.Data(),outputAvg.Data(),database_stem.Data())<<endl;
