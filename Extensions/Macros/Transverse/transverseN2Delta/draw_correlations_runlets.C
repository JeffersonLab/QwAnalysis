...
//connect to the data bases
  db = TSQLServer::Connect("mysql://qweakdb.jlab.org/qw_run2_pass5","qweak", "QweakQweak");
...
//   get_data1("uslumi1_sum", "LUMI", goodfor, target, "out", &valuexout,  &errxout);
//   get_data1("uslumi1_sum", "LUMI", goodfor, target, "in",  &valuexin, &errxin);
