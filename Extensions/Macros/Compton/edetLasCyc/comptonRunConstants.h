...
const Double_t laserFracLo = 0.1;///typical laser off 2E3 ///this is protected explicitly in expAsym.C
...
const Int_t Cedge_p1 = 62;///Compton-edge for the current run(counting from 0)
const Int_t Cedge_p2 = 62;///Compton-edge for the current run(counting from 0)
const Int_t Cedge_p3 = 61;///Compton-edge for the current run(counting from 0)
