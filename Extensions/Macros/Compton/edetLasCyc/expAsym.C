...
Int_t expAsym(Int_t runnum, Float_t stripAsym[nPlanes][nStrips], Float_t stripAsymEr[nPlanes][nStrips], Float_t stripAsym_v2[nPlanes][nStrips], Float_t stripAsymEr_v2[nPlanes][nStrips], Bool_t isFirst100k=kFALSE) //, Float_t stripAsymRMS[nPlanes][nStrips]
{
  ...
  for(Int_t nCycle=0; nCycle<nLasCycles; nCycle++) { 
    ...
    if (beamOn) {
      ...
      Float_t iCounterH1L1  = comptQH1L1 *nMpsB1H1L1 /MpsRate;//this really gives charge for this configuration
      Float_t iCounterH0L1  = comptQH0L1 *nMpsB1H0L1 /MpsRate;
      Float_t iCounterH1L0L = comptQH1L0L*nMpsB1H1L0L/MpsRate;      
      Float_t iCounterH0L0L = comptQH0L0L*nMpsB1H0L0L/MpsRate;
      Float_t iCounterH1L0R = comptQH1L0R*nMpsB1H1L0R/MpsRate;
      Float_t iCounterH0L0R = comptQH0L0R*nMpsB1H0L0R/MpsRate;
...
* comptQ**** variables contain current while iCounter**** contain charge...sorry
******************************************************/
