...
//void qNormVariables(Int_t totCountsB1L0[nStrips],Int_t totCountsB1L1[nStrips],Int_t totQL0,Int_t totQL1)
//{
//    for (Int_t s =startStrip; s <endStrip; s++) {        
//      qNormCountsB1L1[s]  = (totCountsB1L1[s])/((Double_t)(totQL1/helRate));
//      qNormCountsB1L0[s]  = (totCountsB1L0[s])/((Double_t)(totQL0/helRate));
//      BCqNormBkgdSubAllB1L1[s]=qNormCountsB1L1[s]-qNormCountsB1L0[s];
//      BCqNormBkgdSubAllB1L1Er[s] = (TMath::Sqrt(BCqNormBkgdSubAllB1L1[s]))/(Double_t)(totQL1/helRate);
//      qNormAllB1L0Er[s] = (TMath::Sqrt(totCountsB1L0[s]))/(Double_t)(totQL0/helRate);
//
