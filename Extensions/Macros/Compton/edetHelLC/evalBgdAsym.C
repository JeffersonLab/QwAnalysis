...
Int_t evalBgdAsym(Double_t countsLCB1H1L0[], Double_t countsLCB1H0L0[], Double_t qAvgLCH1L0, Double_t qAvgLCH0L0, Double_t tOff, Double_t attenFactor[]) 
{
  ...
  for (Int_t s =startStrip; s <endStrip; s++) {	  
    ...
    if(debug) printf("%d\t%f\t%f\t%f\t%f\t%f\t%f\n",s+1, countsLCB1H1L0[s], newCntsB1H1L0[s], c2B1H1L0[s], rateB0[s], qAvgLCH1L0, qNormCntsLCB1H1L0[s]);
    if(debug) printf("%d\t%f\t%f\t%f\t%f\t%f\t%f\n",s+1, countsLCB1H0L0[s], newCntsB1H0L0[s], c2B1H0L0[s], rateB0[s], qAvgLCH0L0, qNormCntsLCB1H0L0[s]);
