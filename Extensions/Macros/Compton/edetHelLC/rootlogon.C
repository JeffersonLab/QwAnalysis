...
// use plain black on white colors
  ...
  pubStyle->SetPadRightMargin(0.09);
  pubStyle->SetPadBottomMargin(0.16);
  pubStyle->SetPadLeftMargin(0.12);

  // use large Times-Roman fonts
  pubStyle->SetTextFont(132);
  pubStyle->SetTextSize(0.08);
  pubStyle->SetLabelFont(132,"x");
  pubStyle->SetLabelFont(132,"y");
  pubStyle->SetLabelFont(132,"z");
  pubStyle->SetLabelSize(0.05,"x");
  pubStyle->SetTitleSize(0.06,"x");
  pubStyle->SetLabelSize(0.05,"y");
  pubStyle->SetTitleSize(0.06,"y");
