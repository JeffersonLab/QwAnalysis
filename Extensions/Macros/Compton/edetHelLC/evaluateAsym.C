...
Int_t evaluateAsym(Double_t countsLCB1H1L1[nPlanes][nStrips],Double_t countsLCB1H1L0[nPlanes][nStrips],Double_t countsLCB1H0L1[nPlanes][nStrips],Double_t countsLCB1H0L0[nPlanes][nStrips],Double_t qAvgLCH1L1,Double_t qAvgLCH1L0,Double_t qAvgLCH0L1,Double_t qAvgLCH0L0,Double_t wmNrAsym[nPlanes][nStrips],Double_t wmDrAsym[nPlanes][nStrips],Double_t wmNrBCqNormSum[nPlanes][nStrips],Double_t wmDrBCqNormSum[nPlanes][nStrips],Double_t wmNrBCqNormDiff[nPlanes][nStrips],Double_t wmNrqNormB1L0[nPlanes][nStrips],Double_t wmDrqNormB1L0[nPlanes][nStrips],Double_t wmNrBkgdAsym[nPlanes][nStrips],Double_t wmDrBkgdAsym[nPlanes][nStrips],Double_t qNormLasCycAsym[nPlanes][nStrips],Double_t LasCycAsymErSqr[nPlanes][nStrips])
{
  ...
  for (Int_t p =startPlane; p <endPlane; p++) {	  	  
    for (Int_t s =startStrip; s <endStrip; s++) {	  
      ...
      qNormCountsLCB1H1L1=countsLCB1H1L1[p][s]/qAvgLCH1L1;
      qNormCountsLCB1H1L0=countsLCB1H1L0[p][s]/qAvgLCH1L0;
      qNormCountsLCB1H0L1=countsLCB1H0L1[p][s]/qAvgLCH0L1;
      qNormCountsLCB1H0L0=countsLCB1H0L0[p][s]/qAvgLCH0L0;
      ...
      if(BCqNormLasCycSum>0.0) {
        ...
        if (bkgdAsymErSqr > 0.0) {///eqn 4.17(Bevington)
          ...
          cout<<"the bkgdAsymErSqr shouldn't be normally negative; check:strip\tcountsLCB1H1L0\tH0L0\n"
            <<s<<"\t"<<countsLCB1H1L0[p][s]<<"\t"<<countsLCB1H0L0[p][s]<<"\t"<<
        ...
        cout<<red<<"\nReporting a laser cycle which was probably engulfed in a beamTrip"<<normal<<endl;
        cout<<"plane\tstrip\tcountsLCB1H1L1\t...H1L0\t...H0L1\t...H0L0\n"<<
        p+1<<"\t"<<s+1<<"\t"<<countsLCB1H1L1[p][s]<<"\t"<<countsLCB1H1L0[p][s]<<"\t"<<countsLCB1H0L1[p][s]<<"\t"<<countsLCB1H0L0[p][s]<<endl;
        ...
        //cout<<"skipping this call of evaluateAsym.C"<<endl;
        //return -1;
      }
    }//for (Int_t s =startStrip; s <endStrip; s++) {	
  }///for (Int_t p =startPlane; p <endPlane; p++) { 
