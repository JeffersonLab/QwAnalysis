...
Int_t plotScalerByRun(Int_t runStart=20300, Int_t runEnd=20409)
{
  const Int_t LEN = 500;
  ...
  mgSc->Fit("pol0");
  mgSc->Draw("AP");
  TLegend *legend1 = new TLegend(0.87,0.67,0.98,0.835);
  //legend1->SetHeader("Some histograms");
  ...
  //c1->BuildLegend();
  TLegend *legend2 = new TLegend(0.87,0.67,0.98,0.835);
  //legend1->SetHeader("Some histograms");
