...
// used to generate this class and read the Tree.
   ...
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->
                 GetListOfFiles()->
                 FindObject(Form("/home/mjmchugh/qweak/rootfiles/tracking_pass3b/Qweak_%d.root",run));
      if (!f || !f->IsOpen()) {
         f = new TFile(Form("/home/mjmchugh/qweak/rootfiles/tracking_pass3b/Qweak_%d.root",run));
      }
...
Neutral_Fraction::Neutral_Fraction(Int_t Run, Int_t TS1_oct, Int_t TS2_oct) : fChain(0) {
   ...
   chain->Add(Form("/home/mjmchugh/qweak/rootfiles/tracking_pass3b/Qweak_%d.root",run));
