...
void q2_check(int event_start=0,int event_end=-1,int run=8658,string suffix=""){
  ...
  //string folder="/scratch/sxyang";
   ...
   QwTrack* track=0;
	...
	if(track->GetPackage()==1 && tsm_value_1 >-1800 && tsm_value_1 < -1200 && tsp_value_1 > -1800 && tsp_value_1 < -1200){
	...
	angle_1->Fill(track->fScatteringAngle);
	  ...
	  q2->Fill(track->fQ2);
      	...
      	else if(track->GetPackage()==2 && tsm_value_2 > -1800 && tsm_value_2 <-1200 && tsp_value_2 > -1800 && tsp_value_2 < -1200 ){
	  //   else{
    ...
    cout << "q2: " << endl;
    cout << "all: " <<  setprecision(5) << 100*q2->GetMean() << " error RMS/sqrt(N): " <<  setprecision(4) << 100*q2->GetRMS()/sqrt(q2->GetEntries()) << endl;
    cout << "pkg1: " <<  setprecision(5) << 100*q2_1->GetMean() << " error RMS/sqrt(N): " <<  setprecision(4) << 100*q2_1->GetRMS()/sqrt(q2_1->GetEntries()) << endl;
    cout << "pkg2: " <<  setprecision(5) << 100*q2_2->GetMean() << " error RMS/sqrt(N): " <<  setprecision(4) << 100*q2_2->GetRMS()/sqrt(q2_2->GetEntries()) << endl;
