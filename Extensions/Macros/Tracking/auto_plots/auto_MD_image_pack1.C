...
//
//  It is only for the MD "imaged" by Region 3 package 1.
...
//  event_tree->Add("$QW_ROOTFILES/Qweak_10638.root");
  ...
  fout.open(outputPrefix+"md_image_p1.txt");
  fout2.open(outputPrefix+"md_attenuation_p1.txt");
...
// How many events are in this rootfile?
  ...
  cout << "octant number = " << md_number << "  package = 1" << endl; 
...
TCanvas  *c = new TCanvas("c","Region 3 Projections",10, 10, 800,800);
  ...
  c->SaveAs(outputPrefix+"MD_projections_p1.png");
  c->SaveAs(outputPrefix+"MD_projections_p1.C");
...
TCanvas  *pedestals = new TCanvas("pedestals", "Pedestal Data", 10, 10, 800, 800);
  ...
  pedestals->SaveAs(outputPrefix+"MD_ADC_pedestals_p1.png");
  pedestals->SaveAs(outputPrefix+"MD_ADC_pedestals_p1.C");
...
TCanvas  *quad = new TCanvas("quad", "ADC and TDC data", 10, 10, 800, 800);
  ...
  quad->SaveAs(outputPrefix+"MD_ADC_and_TDC_p1.png");
  quad->SaveAs(outputPrefix+"MD_ADC_and_TDC_p1.C");
...
TCanvas  *hitandmiss = new TCanvas("hitandmiss", "Hit and Miss Charts", 10, 10, 800, 800);
  ...
  hitandmiss->SaveAs(outputPrefix+"MD_hit_and_miss_p1.png");
  hitandmiss->SaveAs(outputPrefix+"MD_hit_and_miss_p1.C");
...
TCanvas  *fulls = new TCanvas("FULLS","Full Profiles", 10, 10, 800, 800);
  ...
  fulls->SaveAs(outputPrefix+"MD_full_profiles_p1.png");
  fulls->SaveAs(outputPrefix+"MD_full_profiles_p1.C");
...
// Make the efficiency plots used for the mean radial location calculation
  ...
  EFF->SaveAs(outputPrefix+"MD_radial_projection_p1.png");
  EFF->SaveAs(outputPrefix+"MD_radial_projection_p1.C");
