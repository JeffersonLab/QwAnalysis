...
void auto_r2_projections(Int_t runnum, Bool_t isFirst100K = kFALSE, int event_start=-1, int event_end=-1, TString stem="Qweak_", TString suffix=""){
   ...
   */
   ...
   // only looks at first hit in MD's multihit TDCs - not ideal logic
    ...
    p1_projection_coll1->SetTitle(Form("run %d: Package 1: projection to collimator 1, Z=%f",runnum,z_coll1));
    ...
    p1_projection_coll2->SetTitle(Form("run %d: Package 1: projection to collimator 2, Z=%f",runnum,z_coll2));
    ...
    *t6= TLine(px[5],py[5],px[3],py[3]);
    ...
    TPad* spad7=new TPad("spad7","spad7",.61,.51,.99,.99);
    ...
    TPad* spad12=new TPad("spad12","spad12",.61,.51,.99,.99);
    ...
    p2_projection_coll1->SetTitle(Form("run %d: Package 2:  projection to collimator 1, Z=%f",runnum,z_coll1));
    ...
    *t6= TLine(px[5],py[5],px[3],py[3]);
    ...
    TPad* spad42=new TPad("spad42","spad42",.61,.51,.99,.99);
    ...
    p2_projection_coll2->SetTitle(Form("run %d: Package 2:  projection to collimator 2, Z=%f",runnum,z_coll2));
   ...
   fout << runnum << "\t 1 \tcoll 1\t   x\t" << p1_projection_coll1->ProjectionX()->GetMean() << "\t" << p1_projection_coll1->ProjectionX()->GetRMS() << endl;

   fout << runnum << "\t 1 \tcoll 1\t   y \t" << p1_projection_coll1->ProjectionY()->GetMean() << "\t" << p1_projection_coll1->ProjectionY()->GetRMS() << endl;

   fout << runnum << "\t 1 \tcoll 2\t   x \t" << p1_projection_coll2->ProjectionX()->GetMean() << "\t" << p1_projection_coll2->ProjectionX()->GetRMS() << endl;

   fout << runnum << "\t 1 \tcoll 2\t   y \t" << p1_projection_coll2->ProjectionY()->GetMean() << "\t" << p1_projection_coll2->ProjectionY()->GetRMS() << endl;

   fout << runnum << "\t 1 \tlH2\t   x \t" << p1_projection_lh2->ProjectionX()->GetMean() << "\t" << p1_projection_lh2->ProjectionX()->GetRMS() << endl;

   fout << runnum << "\t 1 \tlH2\t   y \t" << p1_projection_lh2->ProjectionY()->GetMean() << "\t" << p1_projection_lh2->ProjectionY()->GetRMS() << endl;

   fout << runnum << "\t 2 \tcoll 1\t   x\t" << p2_projection_coll1->ProjectionX()->GetMean() << "\t" << p2_projection_coll1->ProjectionX()->GetRMS() << endl;

   fout << runnum << "\t 2 \tcoll 1\t   y \t" << p2_projection_coll1->ProjectionY()->GetMean() << "\t" << p2_projection_coll1->ProjectionY()->GetRMS() << endl;

   fout << runnum << "\t 2 \tcoll 2\t   x \t" << p2_projection_coll2->ProjectionX()->GetMean() << "\t" << p2_projection_coll2->ProjectionX()->GetRMS() << endl;

   fout << runnum << "\t 2 \tcoll 2\t   y \t" << p2_projection_coll2->ProjectionY()->GetMean() << "\t" << p2_projection_coll2->ProjectionY()->GetRMS() << endl;

   fout << runnum << "\t 2 \tlH2\t   x \t" << p2_projection_lh2->ProjectionX()->GetMean() << "\t" << p2_projection_lh2->ProjectionX()->GetRMS() << endl;

   fout << runnum << "\t 2 \tlH2\t   y \t" << p2_projection_lh2->ProjectionY()->GetMean() << "\t" << p2_projection_lh2->ProjectionY()->GetRMS() << endl;
