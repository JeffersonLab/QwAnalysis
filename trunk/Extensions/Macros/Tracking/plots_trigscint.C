...
void plot() {
 ...
 c2->Divide(2,3);
 c2->cd(1);
 event_tree->Draw("ts1m_f1>>h1(400,-2000,-1200)","ts1m_f1!=0");
 c2->cd(2);
 event_tree->Draw("ts2m_f1>>h2(400,-2000,-1200)","ts2m_f1!=0");
 c2->cd(3);
 event_tree->Draw("ts1p_f1>>h3(400,-2000,-1200)","ts1p_f1!=0");
 c2->cd(4);
 event_tree->Draw("ts2p_f1>>h4(400,-2000,-1200)","ts2p_f1!=0");
 c2->cd(5);
 event_tree->Draw("ts1mt_f1>>h5(60,-1200,-1140)","ts1mt_f1!=0");
 c2->cd(6);
 event_tree->Draw("ts2mt_f1>>h6(60,-1200,-1140)","ts2mt_f1!=0");
