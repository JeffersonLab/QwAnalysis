...
void DefineOptionsParity(QwOptions& options)
{
  ...
  //gQwOptions.AddOptions()("helicity.user", po::value<bool>()->zero_tokens(), "QwHelicty: User mode helicity data stream");
  //gQwOptions.AddOptions()("helicity.input", po::value<bool>()->zero_tokens(), "QwHelicty: Input register mode helicity data stream");
