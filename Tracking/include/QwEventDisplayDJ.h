#ifndef QWEVENTDISPLAYDJ_H
#define QWEVENTDISPLAYDJ_H
...
class QwEventDisplayDJ: public TGMainFrame{  // display is a ROOT main frame class
 ...
 public:
  QwEventDisplayDJ(const TGWindow *p, UInt_t w, UInt_t h);
  virtual ~QwEventDisplayDJ();
  ...
  ClassDef(QwEventDisplayDJ,1);
};

#endif //QWEVENTDISPLAYDJ
